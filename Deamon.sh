...
function showUsage {
      echo " "
      echo "Usage:Deamon.ksh -n No. of parallel workers -t Time Delay in seconds -s program to run -a Arguments file to the program to run [-h]"
      echo " "
      echo " "
      echo "Example: "
      echo "     Deamon.ksh -n 2 -t 10 -s scritp.ksh -a argumentfile"
      echo " "
}
